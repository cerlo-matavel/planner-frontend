...
// export function InviteGuestsModal(props: InviteGuestsModalProps) { usando props.propriedade
            ...
            <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-semibold">Seleccionar convidados</h2>
                ...
                {/* <form onSubmit={props.addNewEmailToInvite} */}
